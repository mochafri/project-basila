                            ...
                            <form action="">
                                <div class="w-[60%] flex flex-col gap-2">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <select name="fakultas" id="fakultas" class="text-neutral-800 uppercase w-[50%] form-select text-sm">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <select name="Semester" id="Semester" class="text-neutral-800 w-[50%] form-select text-sm">
