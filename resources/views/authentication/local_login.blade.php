        ...
        <div class="lg:w-1/2 py-8 px-6 flex flex-col justify-center">
            <div class="lg:max-w-[464px] mx-auto w-full">
                <div>
                    ...
                    <h4 class="mb-3">Local Admin Login</h4>
                    <p class="mb-8 text-secondary-light text-lg">Login khusus bypass dengan full role akses (Superadmin)
                    </p>
                </div>
                ...
                <form action="{{ route('local.login.process') }}" method="POST" class="form">
                    @csrf
                    ...
                    <div class="mt-4 text-center">
                        <a href="{{ route('signin.show') }}" class="text-sm text-neutral-500 hover:text-red-500">Kembali ke SSO Login</a>
                    </div>
                </form>
            </div>
        </div>
